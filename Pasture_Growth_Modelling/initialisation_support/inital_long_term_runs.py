...
from Pasture_Growth_Modelling.basgra_parameter_sets import get_params_doy_irr, create_days_harvest, create_matrix_weather


def run_past_basgra_irrigated():
    mode = 'irrigated'
    ...
    out = run_basgra_nz(params, matrix_weather, days_harvest, doy_irr, doy_irr, verbose=False)
