"""This file will generate irrigation restriction CDFs for use with the IID
 This file takes 3 arguments, the first argument is the path to the restriction record (does not detrend in this file),
 The second argument is the path to event definition data the KSL standard not run through fix_csv.py,
 3rd outdir
 CDFs will be output in outdir as a csv
...
if len(sys.argv) != 4:
    print("Please run with 2 arguments, arg1: restriction record csv,  arg2: event definition data csv, arg3: outdir")
    sys.exit()
