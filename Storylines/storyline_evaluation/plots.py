...
def plot_3yr_no_additional(save=False):
    for mode, site in default_mode_sites:
        ...
        plot_all_nyr(site, mode, nyr=3, outdir=outdir, other_scen=None, other_scen_lbl='other storylines',
                     pt_labels=False)
...
def plot_3yr_additional(get_add_fun, other_scen_lbl, pt_labels=True, save=False):
    for mode, site in default_mode_sites:
        ...
        plot_all_nyr(site, mode, num=5, nyr=3, outdir=outdir, other_scen=additional, other_scen_lbl=other_scen_lbl,
                     pt_labels=pt_labels, step_size=0.1, plt_data_density=False)
