...
def build_example_storylines_for_greg(outdir):
    if not os.path.exists(outdir):
        os.makedirs(outdir)
    data = pd.read_excel(ksl_env.slmmac_dir.joinpath(r"event_definition/example_story_lines.xlsx"),
                         header=[0, 1],
                         skiprows=1
                         )
...
if __name__ == '__main__':
    ...
    build_example_storylines_for_greg(ksl_env.slmmac_dir.joinpath(r"event_definition/example_storys_for_greg"))
